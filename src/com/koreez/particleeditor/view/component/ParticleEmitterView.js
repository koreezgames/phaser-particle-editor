...
export default class ParticleEmitterView {
  ...
  initProperties () {
    ...
    this._color.start = $('#startColor')
      .colorpicker().on('change', this.onEmitterPropertyValueChange.bind(this, this.onStartColorChange))
    this._color.end = $('#endColor')
      .colorpicker().on('change', this.onEmitterPropertyValueChange.bind(this, this.onEndColorChange))
